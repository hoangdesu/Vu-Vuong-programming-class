...
public class App {
    ...
    public static void configureRoutes(Javalin app) {
        ...
        app.post("/filter-data", new FilterDataPageST3BHandler());

        // uncomment the following for groups of 3
        // you will need to copy and create the relevant class file from the
        // corresponding template above
        ...
        // uncomment the following for groups of 3 - for any pages that need a web form
        // POSTS
